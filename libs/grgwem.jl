...
using Seismic, Compat
include("Header.jl")

function grgwem(m::ASCIIString,d::ASCIIString,adj=true;pspi=true,nref=5,damping=1000.,vel="vel",angx="angx",angy="angy",wav="wav",sz=0.,gz=0.,nangx=1,oangx=0,dangx=1,nangy=1,oangy=0,dangy=1,fmin=0,fmax=80,padt=2,padx=2,verbose=false,sx=[0],sy=[0])
...
print("break 2.0 grgwem.jl\n")
		...
		for ishot = 1 : nshot
			...
			j = 1    				
			h_shot = Array(Seismic.Header,nx*ny)
			for imx = 1 : nx
				for imy = 1 : ny
